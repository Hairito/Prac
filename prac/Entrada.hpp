...
private:
	...
	// COMPLETEU
    char c;
    int f;  //Tot i dir-se frequencia, no es exactament la frequencia
            //sino que son el numero d'aparicions. Aixo s'ha fet principalment
            //per evitar errors de precissio amb el tipus de dada double, 
            //per aixo es fa servir el tipus de dada int.
    string code;
